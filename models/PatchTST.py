            ...
            [
                EncoderLayer(
                    AttentionLayer(
                        ...
                        WeightedAverageAttention(d_model=configs.d_model, n_heads=configs.n_heads, mask_flag=False, factor=configs.factor, attention_dropout=configs.dropout, output_attention=configs.output_attention),
